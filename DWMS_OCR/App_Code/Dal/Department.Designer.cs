...
namespace DWMS_OCR.App_Code.Dal {
    ...
    public partial class Department : global::System.Data.DataSet {
        ...
        public partial class DepartmentDataTable : global::System.Data.TypedTableBase<DepartmentRow> {
            ...
            private global::System.Data.DataColumn columnMailingList;
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public global::System.Data.DataColumn MailingListColumn {
                get {
                    return this.columnMailingList;
                }
            }
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public DepartmentRow AddDepartmentRow(string Code, string Name, string MailingList) {
            ...
            internal void InitVars() {
                ...
                this.columnMailingList = base.Columns["MailingList"];
            }
            ...
            private void InitClass() {
                ...
                this.columnMailingList = new global::System.Data.DataColumn("MailingList", typeof(string), null, global::System.Data.MappingType.Element);
                base.Columns.Add(this.columnMailingList);
                ...
                this.columnMailingList.MaxLength = 2147483647;
        ...
        public partial class DepartmentRow : global::System.Data.DataRow {
            ...
            public string MailingList {
                get {
                    try {
                        return ((string)(this[this.tableDepartment.MailingListColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'MailingList\' in table \'Department\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tableDepartment.MailingListColumn] = value;
                }
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public bool IsMailingListNull() {
                return this.IsNull(this.tableDepartment.MailingListColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public void SetMailingListNull() {
                this[this.tableDepartment.MailingListColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace DWMS_OCR.App_Code.Dal.DepartmentTableAdapters {
    ...
    public partial class DepartmentTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            tableMapping.ColumnMappings.Add("MailingList", "MailingList");
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [Department] ([Code], [Name], [MailingList]) VALUES (@Code, @Name, @M" +
                "ailingList);\r\nSELECT Id, Code, Name, MailingList FROM Department WHERE (Id = SCO" +
                "PE_IDENTITY())";
            ...
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@MailingList", global::System.Data.SqlDbType.NVarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "MailingList", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = "UPDATE [Department] SET [Code] = @Code, [Name] = @Name, [MailingList] = @MailingL" +
                "ist WHERE (([Id] = @Original_Id));\r\nSELECT Id, Code, Name, MailingList FROM Depa" +
                "rtment WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@MailingList", global::System.Data.SqlDbType.NVarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "MailingList", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT        Id, Code, Name, MailingList\r\nFROM            Department";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT Code, Id, MailingList, Name FROM Department WHERE (Code = @Code)";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Code", global::System.Data.SqlDbType.Char, 10, global::System.Data.ParameterDirection.Input, 0, 0, "Code", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[2] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[2].Connection = this.Connection;
            this._commandCollection[2].CommandText = "SELECT        Department.*\r\nFROM            Department\r\nWHERE Id=@Id";
        ...
        public virtual Department.DepartmentDataTable GetDataByCode(string Code) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, false)]
        public virtual Department.DepartmentDataTable GetDataById(int Id) {
        ...
        public virtual int Insert(string Code, string Name, string MailingList) {
            if ((Code == null)) {
                throw new global::System.ArgumentNullException("Code");
            }
            else {
            ...
            if ((MailingList == null)) {
                ...
                this.Adapter.InsertCommand.Parameters[2].Value = ((string)(MailingList));
            }
        ...
        public virtual int Update(string Code, string Name, string MailingList, int Original_Id, int Id) {
            if ((Code == null)) {
                throw new global::System.ArgumentNullException("Code");
            }
            else {
            ...
            if ((MailingList == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[2].Value = ((string)(MailingList));
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Code, string Name, string MailingList, int Original_Id) {
            return this.Update(Code, Name, MailingList, Original_Id, Original_Id);
        }
    }
    ...
    public partial class TableAdapterManager : global::System.ComponentModel.Component {
        ...
        private int UpdateUpdatedRows(Department dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allChangedRows, global::System.Collections.Generic.List<global::System.Data.DataRow> allAddedRows) {
            int result = 0;
            if ((this._departmentTableAdapter != null)) {
                global::System.Data.DataRow[] updatedRows = dataSet._Department.Select(null, null, global::System.Data.DataViewRowState.ModifiedCurrent);
        ...
        private int UpdateInsertedRows(Department dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allAddedRows) {
            int result = 0;
            if ((this._departmentTableAdapter != null)) {
                global::System.Data.DataRow[] addedRows = dataSet._Department.Select(null, null, global::System.Data.DataViewRowState.Added);
                if (((addedRows != null) 
                            && (0 < addedRows.Length))) {
        ...
        private int UpdateDeletedRows(Department dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allChangedRows) {
            int result = 0;
            if ((this._departmentTableAdapter != null)) {
                global::System.Data.DataRow[] deletedRows = dataSet._Department.Select(null, null, global::System.Data.DataViewRowState.Deleted);
                if (((deletedRows != null) 
