...
{
    public class VerifyRequestorCustomer
    {
    ...
    public class VerifySendToCDB
    {
        //public BE01JAuthenticationDTO BE01JAuthenticationDTO;
        public VerifyDocWebRef.BE01JSystemInfoDTO BE01JSystemInfoDTO;
        public VerifyDocWebRef.BE01JBusinessInfoDTO BE01JBusinessInfoDTO;
        public VerifyDocWebRef.BE01JOutputDTO BE01JOutputDTO;
    }

    public class CDBVerifyUtil
    {
        ...
        protected bool ProcessOutput(VerifyDocWebRef.BE01JOutputDTO response, VerifyDocWebRef.BE01JBusinessInfoDTO businessInfo, VerifyDocWebRef.BE01JSystemInfoDTO systemInfo, VerifyDocWebRef.BE01JAuthenticationDTO authentication, SendToCDBStageEnum stage)
        {
            ...
            try
            {
                if (response != null)
                {
                    ...
                    {
                        VerifyDocWebRef.BE01BusinessOutput businessOutput = response.businessOutput;
                        ...
                        if (businessOutput.customerOutputList != null)
                        {
                            ...
                            foreach (VerifyDocWebRef.BE01CustomerOutput customerOutput in businessOutput.customerOutputList)
                            {
                                //Util.CDBLog("HAHA", "in customer loop", EventLogEntryType.Warning);

                                VerifyDocWebRef.BE01JCustomerInfoDTO customerInfo = businessInfo.customerInfoList[customerCount];
                                if (customerOutput.documentOutputList != null)
                                {
                                    ...
                                    foreach (VerifyDocWebRef.BE01DocumentOutput documentOutput in customerOutput.documentOutputList)
                                    {
                                        try
                                        {
                                            //Util.CDBLog("HAHA", "in document loop customer: " + customerCount + "Document: " + documentCount, EventLogEntryType.Warning);
                                            VerifyDocWebRef.BE01JDocumentInfoDTO documentInfo = businessInfo.customerInfoList[customerCount].documentInfoList[documentCount];
                                            ...
                                            if (documentOutput.imageOutputList != null)
                                            {
                                                ...
                                                foreach (VerifyDocWebRef.BE01ImageOutput imageOutput in documentOutput.imageOutputList)
                                                {
                                                    try
                                                    {
                                                        switch (documentInfo.docChannel)
                                                        {
                                                            ...
                                                            case "009":
                                                                channelType = "Mixed";
                                                                break;
                                                            case "011": //Added By Edward 01.11.2013 011 New Channel
                                                                channelType = "MyHDBPage Common Panel";
                                                                break;
                                                            default:
                                                                channelType = "Err No Doc Channel";
                                                                break;
                                                        }
                                                        VerifyDocWebRef.BE01JImageInfoDTO imageInfo = businessInfo.customerInfoList[customerCount].documentInfoList[documentCount].imageInfoList[imageCount];
                                                        ...
                                                        if (stage.ToString().ToUpper() == "VERIFIED" && isCDBUpdateResultToDBVerify())
                                                        {
                                                            ...
                                                            {
                                                                if (imageOutput.cmDocumentId.Substring(0, 3) != "XXX")
                                                                    docDb.UpdateSentToCDBStatus(docId, SendToCDBStatusEnum.Sent, SendToCDBStatusEnum.Ready);
                                                                else 
                                                                    docDb.UpdateSentToCDBStatus(docId, SendToCDBStatusEnum.NotReady, SendToCDBStatusEnum.NotReady);

                                                                docDb.UpdateCmDocumentId(docId, imageOutput.cmDocumentId);
                                                                //docAppDb.UpdateSentToCDBStatus((int)docAppRow["Id"], SendToCDBStatusEnum.Ready, 0);
                                                            ...
                                                            else
                                                            {
                                                                ...
                                                                Util.CDBDetailLog(string.Empty, String.Format("Stage " + stage.ToString() + " Document Id: " + docId + " imageOutput Result:" + imageOutput.resultFlg + " updated to " + SendToCDBStatusEnum.SentButFailed.ToString()), EventLogEntryType.Information);
                                                                docDb.UpdateSentToCDBStatus(docId, SendToCDBStatusEnum.SentButFailed, SendToCDBStatusEnum.NotReady);
                                                            }
                                                        }
                                                        else if (stage.ToString().ToUpper() == "MODIFIEDVERIFIED" && isCDBUpdateResultToDBAccept())
                                                        {
                                                            ...
                                                            else
                                                            {
                                                                ...
                                                                Util.CDBDetailLog(string.Empty, String.Format("Stage " + stage.ToString() + " Document Id: " + docId + " imageOutput Result:" + imageOutput.resultFlg + " updated to " + SendToCDBStatusEnum.ModifiedSetSentButFailed.ToString()), EventLogEntryType.Information);
                                                                docDb.UpdateSentToCDBStatus(docId, SendToCDBStatusEnum.ModifiedSetSentButFailed, SendToCDBStatusEnum.NotReady);
                                                        ...
                                                        try
                                                        {
                                                            if (imageOutput.personOutputList != null)
                                                            {
                                                                ...
                                                                foreach (VerifyDocWebRef.BE01PersonOutput personOutput in imageOutput.personOutputList)
                                                                {
                                                                    //Util.CDBLog("HAHA", "in personIdentity loop", EventLogEntryType.Warning);

                                                                    VerifyDocWebRef.BE01JPersonIdentityInfoDTO personIdentityInfo = businessInfo.customerInfoList[customerCount].documentInfoList[documentCount].imageInfoList[imageCount].personInfoList[personCount];
                                                                    if (personIdentityInfo.personInfo != null)
                                                                    {
                                                                        //Util.CDBLog("HAHA", "in person start", EventLogEntryType.Warning);

                                                                        VerifyDocWebRef.BE01JPersonInfoDTO personInfo = businessInfo.customerInfoList[customerCount].documentInfoList[documentCount].imageInfoList[imageCount].personInfoList[personCount].personInfo;
                                                        ...
                                                        {
                                                            Util.CDBLog(string.Empty, String.Format("3Error while deleting the input file, both input and output file will be available, Message: " + ex.Message), EventLogEntryType.Warning);
                                                        }
                                                       #endregion
                                                    }
                                                    catch (Exception ex)
                                                    {
                                                        Util.CDBLog(string.Empty, String.Format("2Error while deleting the input file, both input and output file will be available, Message: " + ex.Message), EventLogEntryType.Warning);
                                                    }
                                                    imageCount++;
                                                }
                                            }
                                        ...
                                        {
                                            Util.CDBLog(string.Empty, String.Format("1Error while deleting the input file, both input and output file will be available, Message: " + ex.Message), EventLogEntryType.Warning);
                                        }
                                        documentCount++;
                                    }
                                }
        ...
        protected bool GenerateOutputTextFile(string filePathOut, string filePath, VerifyDocWebRef.BE01JOutputDTO response, VerifyDocWebRef.BE01JBusinessInfoDTO businessInfo, VerifyDocWebRef.BE01JSystemInfoDTO systemInfo, VerifyDocWebRef.BE01JAuthenticationDTO authentication, SendToCDBStageEnum stage)
        {
                                            ...
                                            foreach (VerifyDocWebRef.BE01ImageOutput imageOutput in documentOutput.imageOutputList)
                                            {
                                                ...
                                                else if (stage.ToString().ToUpper() == "MODIFIEDVERIFIED" && isCDBUpdateResultToDBAccept())
                                                {
                                                    ...
                                                    else
                                                    {
                                                        ...
                                                        Util.CDBDetailLog(string.Empty, String.Format("Stage " + stage.ToString() + " Document Id: " + imageOutput.dwmsDocumentId + " imageOutput Result:" + imageOutput.resultFlg + " updated to " + SendToCDBStatusEnum.ModifiedSetSentButFailed.ToString()), EventLogEntryType.Information);
                                                        docDb.UpdateSentToCDBStatus(Convert.ToInt32(documentInfo.docId.Trim()), SendToCDBStatusEnum.ModifiedSetSentButFailed, SendToCDBStatusEnum.NotReady);
        ...
        protected bool GenerateInputTextFile(VerifyDocWebRef.BE01JSystemInfoDTO systemInfo, VerifyDocWebRef.BE01JBusinessInfoDTO businessInfo, VerifyDocWebRef.BE01JAuthenticationDTO authentication, string filePath)
        {
            ...
            try
            {
                ...
                {
                    foreach (VerifyDocWebRef.BE01JCustomerInfoDTO customer in businessInfo.customerInfoList)
                    {
                        ...
                        {
                            //Business >> Customer >> documents
                            foreach (VerifyDocWebRef.BE01JDocumentInfoDTO document in customer.documentInfoList)
                            {
                                ...
                                if (document.imageInfoList != null)
                                {
                                    ...
                                    //Business >> Customer >> documents >> Image
                                    foreach (VerifyDocWebRef.BE01JImageInfoDTO image in document.imageInfoList)
                                    {
                                        w.Write("~~~~~~~~~IMAGE INFO~~~~~~~~~~" + "\r\n");
                                        ...
                                        if (image.personInfoList != null)
                                        {
                                            ...
                                            //Business >> Customer >> documents >> Image >> Person
                                            foreach (VerifyDocWebRef.BE01JPersonIdentityInfoDTO personIdentity in image.personInfoList)
                                            {
        ...
        protected VerifyDocWebRef.BE01JBusinessInfoDTO XmlInput(string fileFullPath, ref VerifyDocWebRef.BE01JSystemInfoDTO systemInfo, ref VerifyDocWebRef.BE01JAuthenticationDTO authentication)
        {
            Util.CDBLog(string.Empty, "Start: Importing data from XML file", EventLogEntryType.Information);

            VerifyDocWebRef.BE01JBusinessInfoDTO businessInfo;
            try
            {
                ...
                businessInfo = new VerifyDocWebRef.BE01JBusinessInfoDTO();
                ...
                List<VerifyDocWebRef.BE01JCustomerInfoDTO> customers = new List<VerifyDocWebRef.BE01JCustomerInfoDTO>();

                foreach (XmlNode customerNode in customerInfoList)
                {
                    VerifyDocWebRef.BE01JCustomerInfoDTO customer = new VerifyDocWebRef.BE01JCustomerInfoDTO();
                    ...
                    List<VerifyDocWebRef.BE01JDocumentInfoDTO> documents = new List<VerifyDocWebRef.BE01JDocumentInfoDTO>();
                    ...
                    {
                        VerifyDocWebRef.BE01JDocumentInfoDTO document = new VerifyDocWebRef.BE01JDocumentInfoDTO();
                        ...
                        List<VerifyDocWebRef.BE01JImageInfoDTO> images = new List<VerifyDocWebRef.BE01JImageInfoDTO>();
                        ...
                        {
                            VerifyDocWebRef.BE01JImageInfoDTO image = new VerifyDocWebRef.BE01JImageInfoDTO();
                            ...
                            List<VerifyDocWebRef.BE01JPersonIdentityInfoDTO> personsIdentities = new List<VerifyDocWebRef.BE01JPersonIdentityInfoDTO>();
                            ...
                            {
                                VerifyDocWebRef.BE01JPersonIdentityInfoDTO personIdentity = new VerifyDocWebRef.BE01JPersonIdentityInfoDTO();
                                ...
                                if (personInfoListNode != null)
                                {
                                    ...
                                    VerifyDocWebRef.BE01JPersonInfoDTO person = new VerifyDocWebRef.BE01JPersonInfoDTO();
        ...
        protected bool GenerateXmlOutput(string filePath, VerifyDocWebRef.BE01JOutputDTO response, VerifyDocWebRef.BE01JBusinessInfoDTO businessInfo, VerifyDocWebRef.BE01JSystemInfoDTO systemInfo)
        {
            try
            {
                VerifySendToCDB verifySendToCDB = new VerifySendToCDB();
                verifySendToCDB.BE01JSystemInfoDTO = systemInfo;
                verifySendToCDB.BE01JBusinessInfoDTO = businessInfo;
                verifySendToCDB.BE01JOutputDTO = response;
                //sendToCDB.BE01JAuthenticationDTO = authentication;


                System.Xml.Serialization.XmlSerializer writer = new System.Xml.Serialization.XmlSerializer(typeof(VerifySendToCDB));
                ...
                writer.Serialize(file, verifySendToCDB);
        ...
        protected VerifyDocWebRef.BE01JDocumentInfoDTO[] GetDocumentInfo(DataTable docsTable, VerifyRequestorCustomer requestedCustomer, int docAppId, SendToCDBStageEnum stage, out int count)
        {
            //Get Doc info for a particular NRIC
            //Get document list for the customer
            List<VerifyDocWebRef.BE01JDocumentInfoDTO> documentList = new List<VerifyDocWebRef.BE01JDocumentInfoDTO>();
            count = 0;
                ...
                if (docsTable.Rows.Count > 0)
                {
                    ...
                    foreach (DataRow docRow in docsTable.Rows)
                    {
                        ...
                        if (docId.HasValue)
                        {
                            ...
                            {
                                VerifyDocWebRef.BE01JDocumentInfoDTO document;

                                DataRow row = dtDoc.Rows[0];
                                if (row != null)
                                {
                                    document = new VerifyDocWebRef.BE01JDocumentInfoDTO();
                                    ...
                                    if (document.imageInfoList.Count() > 0)
                                    //if (document.docEndDate >= document.docStartDate)// && document.imageInfoList.Count() > 0)
                                    {
                                        documentList.Add(document);
                                        count++;
                                    }
                                    else
                                        Util.CDBDetailLog(string.Empty, String.Format("Doc Detail(s) for DocId: {1} failed.", docId.Value), EventLogEntryType.Error);
                                }
                            }
                        }
                    }
            ...
            {
                string errorMessage = String.Format("Processing Doc Error: Message={0}, StackTrace={1}", ex.Message, ex.StackTrace);
        ...
        private VerifyDocWebRef.BE01JImageInfoDTO[] GetImageInfo(DataTable dtDoc, VerifyRequestorCustomer requestedCustomer, int docAppId, SendToCDBStageEnum stage)
        {

            List<VerifyDocWebRef.BE01JImageInfoDTO> imageList = new List<VerifyDocWebRef.BE01JImageInfoDTO>();

            try
            {
                if (dtDoc.Rows.Count > 0)
                {
                    VerifyDocWebRef.BE01JImageInfoDTO image;
                    ...
                    foreach (DataRow row in dtDoc.Rows)
                    {
                        ...
                        if (row != null)
                        {
                            ...
                            image = new VerifyDocWebRef.BE01JImageInfoDTO();
                            ...
                            if (fileSizeKB > 0 && image.imageUrl.Length > 0)
                            {
                                imageList.Add(image);
                            }
                            else
                                Util.CDBDetailLog(string.Empty, String.Format("Processing Image: {0}  failed to find file.", row["DocId"]), EventLogEntryType.Error);
                        }
            ...
            {
                string errorMessage = String.Format("Processing Image Error: Message={0}, StackTrace={1}",
                             ex.Message, ex.StackTrace);
        ...
        private VerifyDocWebRef.BE01JPersonIdentityInfoDTO[] GetPersonIdentityInfo(int docId, string docType, VerifyRequestorCustomer requestedCustomer, int docAppId, SendToCDBStageEnum stage)
        {
            try
            {
                ...
                List<VerifyDocWebRef.BE01JPersonIdentityInfoDTO> personIdentityList = new List<VerifyDocWebRef.BE01JPersonIdentityInfoDTO>();

                VerifyDocWebRef.BE01JPersonIdentityInfoDTO personIdentity1;
                VerifyDocWebRef.BE01JPersonIdentityInfoDTO personIdentity2;
                VerifyDocWebRef.BE01JPersonIdentityInfoDTO personIdentity3;
                VerifyDocWebRef.BE01JPersonIdentityInfoDTO personIdentity4;


                AppPersonalDb appPersonalDb = new AppPersonalDb();

                VerifyDocWebRef.BE01JPersonInfoDTO person;
                VerifyDocWebRef.BE01JPersonInfoDTO person2;
                ...
                if (dtDocDetails.Rows.Count > 0)
                {
                    switch (docType)
                    {
                        ...
                        case "LastWillDeceased":
                            personIdentity1 = new VerifyDocWebRef.BE01JPersonIdentityInfoDTO();
                        ...
                        case "PowerAttorney":
                            ...
                            personIdentity2 = new VerifyDocWebRef.BE01JPersonIdentityInfoDTO();
                            ...
                            personIdentity3 = new VerifyDocWebRef.BE01JPersonIdentityInfoDTO();
                            ...
                            personIdentity4 = new VerifyDocWebRef.BE01JPersonIdentityInfoDTO();
                        ...
                        case "MarriageCertificate":
                            ...
                            {
                                person = new VerifyDocWebRef.BE01JPersonInfoDTO();
                            ...
                            if (GetFieldValueFromDataTable(dtMetaDocDetails, DocTypeMetaDataMarriageCertificateEnum.IdentityNoSpouse.ToString()).Length > 0 && GetFieldValueFromDataTable(dtMetaDocDetails, DocTypeMetaDataMarriageCertificateEnum.IdentityNoSpouse.ToString()) != GetFieldValueFromDataTable(dtMetaDocDetails, DocTypeMetaDataMarriageCertificateEnum.IdentityNoImageSpouse.ToString()))
                            {    //DataTable appPersonal = appPersonalDb.GetAppPersonalsByDocAppId(docAppId);
                                personIdentity2 = new VerifyDocWebRef.BE01JPersonIdentityInfoDTO();// edited by calvin to take value when personidentity is empty
                                ...
                                personIdentity2.customerName = appPersonalDb.GetCustomerNameByDocAppIdAndNric(docAppId, personIdentity2.identityNo);
                                ...
                                person2 = new VerifyDocWebRef.BE01JPersonInfoDTO();
                            ...
                            {
                                personIdentity2 = new VerifyDocWebRef.BE01JPersonIdentityInfoDTO();// edited by calvin to take value when personidentity is empty
                                personIdentity2.identityNo = GetFieldValueFromDataTable(dtMetaDocDetails, DocTypeMetaDataMarriageCertificateEnum.IdentityNoImageSpouse.ToString());
                                personIdentity2.identityType = GetFieldValueFromDataTable(dtMetaDocDetails, DocTypeMetaDataMarriageCertificateEnum.IDTypeImageSpouse.ToString());
