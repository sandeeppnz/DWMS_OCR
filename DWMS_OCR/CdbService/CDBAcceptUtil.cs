...
{
    public class AcceptRequestorCustomer
    {
    ...
    public class AcceptSendToCDB
    {
        //public BE01JAuthenticationDTO BE01JAuthenticationDTO;
        public AcceptDocWebRef.BE01JSystemInfoDTO BE01JSystemInfoDTO;
        public AcceptDocWebRef.BE01JBusinessInfoDTO BE01JBusinessInfoDTO;
        public AcceptDocWebRef.BE01JOutputDTO BE01JOutputDTO;
    }

    public class CDBAcceptUtil
    {
        ...
        protected bool ProcessOutput(AcceptDocWebRef.BE01JOutputDTO response, AcceptDocWebRef.BE01JBusinessInfoDTO businessInfo, AcceptDocWebRef.BE01JSystemInfoDTO systemInfo, AcceptDocWebRef.BE01JAuthenticationDTO authentication, SendToCDBStageEnum stage)
        {
            ...
            try
            {
                if (response != null)
                {
                    ...
                    {
                        AcceptDocWebRef.BE01BusinessOutput businessOutput = response.businessOutput;
                        ...
                        if (businessOutput.customerOutputList != null)
                        {
                            ...
                            foreach (AcceptDocWebRef.BE01CustomerOutput customerOutput in businessOutput.customerOutputList)
                            {
                                //Util.CDBLog("HAHA", "in customer loop", EventLogEntryType.Warning);

                                AcceptDocWebRef.BE01JCustomerInfoDTO customerInfo = businessInfo.customerInfoList[customerCount];
                                if (customerOutput.documentOutputList != null)
                                {
                                    ...
                                    foreach (AcceptDocWebRef.BE01DocumentOutput documentOutput in customerOutput.documentOutputList)
                                    {
                                        try
                                        {
                                            //Util.CDBLog("HAHA", "in document loop customer: " + customerCount + "Document: " + documentCount, EventLogEntryType.Warning);
                                            AcceptDocWebRef.BE01JDocumentInfoDTO documentInfo = businessInfo.customerInfoList[customerCount].documentInfoList[documentCount];
                                            ...
                                            if (documentOutput.imageOutputList != null)
                                            {
                                                ...
                                                foreach (AcceptDocWebRef.BE01ImageOutput imageOutput in documentOutput.imageOutputList)
                                                {
                                                    try
                                                    {
                                                        ...
                                                        AcceptDocWebRef.BE01JImageInfoDTO imageInfo = businessInfo.customerInfoList[customerCount].documentInfoList[documentCount].imageInfoList[imageCount];

                                                        //Util.CDBLog(string.Empty, "Update status", EventLogEntryType.Warning);
                                                        #region update the status based on image output
                                                        // TODO: Email 
                                                        if (stage.ToString().ToUpper() == "VERIFIED" && isCDBUpdateResultToDBAccept())
                                                        {
                                                        ...
                                                        else if (stage.ToString().ToUpper() == "ACCEPT" && isCDBUpdateResultToDBCompleteAccept())
                                                        {
                                                            ...
                                                            {
                                                                int? docId = docDb.GetDocIdByCmDocId(imageOutput.cmDocumentId);
                                                                //int docId = int.Parse(imageInfo.dwmsDocumentId);
                                                                if (docId.HasValue)
                                                                {
                                                                    if (imageOutput.resultFlg)
                                                                    {
                                                                        ...
                                                                        docDb.UpdateSentToCDBAccept(docId.Value, SendToCDBStatusEnum.Sent);
                                                                    }
                                                                    else
                                                                    {
                                                                        #region Email
                                                                        ...
                                                                        docDb.UpdateSentToCDBAccept(docId.Value, SendToCDBStatusEnum.SentButFailed);
                                                                    }
                                                                }
                                                            }
                                                        }
                                                        ...
                                                        //    foreach (AcceptDocWebRef.BE01PersonOutput personOutput in imageOutput.personOutputList)
                                                        //    {
                                                        //        //Util.CDBLog("HAHA", "in personIdentity loop", EventLogEntryType.Warning);

                                                        //        AcceptDocWebRef.BE01JPersonIdentityInfoDTO personIdentityInfo = businessInfo.customerInfoList[customerCount].documentInfoList[documentCount].imageInfoList[imageCount].personInfoList[personCount];
                                                        //        if (personIdentityInfo.personInfo != null)
                                                        //        {
                                                        //            //Util.CDBLog("HAHA", "in person start", EventLogEntryType.Warning);

                                                        //            AcceptDocWebRef.BE01JPersonInfoDTO personInfo = businessInfo.customerInfoList[customerCount].documentInfoList[documentCount].imageInfoList[imageCount].personInfoList[personCount].personInfo;
                    ...
                    if (response.obsResultFlag.Trim().ToUpper() != CDBAcceptOutputStatus.A.ToString())
                    {
                        // TODO: Email part
                        ExceptionLogDb exceptionLogDb = new ExceptionLogDb();
        ...
        protected bool GenerateOutputTextFile(string filePathOut, string filePath, AcceptDocWebRef.BE01JOutputDTO response, AcceptDocWebRef.BE01JBusinessInfoDTO businessInfo, AcceptDocWebRef.BE01JSystemInfoDTO systemInfo, AcceptDocWebRef.BE01JAuthenticationDTO authentication, SendToCDBStageEnum stage)
        {
                                    ...
                                    foreach (AcceptDocWebRef.BE01DocumentOutput documentOutput in customerOutput.documentOutputList)
                                    {
                                        ...
                                        if (documentOutput.imageOutputList != null)
                                        {
                                            ...
                                            foreach (AcceptDocWebRef.BE01ImageOutput imageOutput in documentOutput.imageOutputList)
                                            {
                                                ...
                                                //w.Write("imageUrl: " + imageInfo.imageUrl + "\r\n");
                                                //w.Write("imageName: " + imageInfo.imageName + "\r\n");
                                                w.Write("accepted: " + imageInfo.imageAccepted + "\r\n");
                                                //w.Write("docRecievedSourceDate: " + imageInfo.docRecievedSourceDate.Value.ToString(datePattern) + "\r\n");
                                                w.Write("cmDocumentId: " + imageInfo.cmDocumentId + "\r\n");
                                                w.Write("dwmsDocumentId: " + imageInfo.dwmsDocumentId + "\r\n");
                                                //w.Write("certificateNumber: " + imageInfo.certificateNumber + "\r\n");
        ...
        protected bool GenerateInputTextFile(AcceptDocWebRef.BE01JSystemInfoDTO systemInfo, AcceptDocWebRef.BE01JBusinessInfoDTO businessInfo, AcceptDocWebRef.BE01JAuthenticationDTO authentication, string filePath)
        {
            ...
            try
            {
                ...
                {
                    foreach (AcceptDocWebRef.BE01JCustomerInfoDTO customer in businessInfo.customerInfoList)
                    {
                        ...
                        {
                            //Business >> Customer >> documents
                            foreach (AcceptDocWebRef.BE01JDocumentInfoDTO document in customer.documentInfoList)
                            {
                                ...
                                if (document.imageInfoList != null)
                                {
                                    ...
                                    //Business >> Customer >> documents >> Image
                                    foreach (AcceptDocWebRef.BE01JImageInfoDTO image in document.imageInfoList)
                                    {
                                        w.Write("~~~~~~~~~IMAGE INFO~~~~~~~~~~" + "\r\n");
                                        //w.Write("imageUrl: " + image.imageUrl + "\r\n");
                                        //w.Write("imageName: " + image.imageName + "\r\n");
                                        w.Write("accepted: " + image.imageAccepted + "\r\n");
                                        ...
                                        //    //Business >> Customer >> documents >> Image >> Person
                                        //    foreach (AcceptDocWebRef.BE01JPersonIdentityInfoDTO personIdentity in image.personInfoList)
                                        //    {
        ...
        protected AcceptDocWebRef.BE01JBusinessInfoDTO XmlInput(string fileFullPath, ref AcceptDocWebRef.BE01JSystemInfoDTO systemInfo, ref AcceptDocWebRef.BE01JAuthenticationDTO authentication)
        {
            Util.CDBLog(string.Empty, "Start: Importing data from XML file", EventLogEntryType.Information);

            AcceptDocWebRef.BE01JBusinessInfoDTO businessInfo;
            try
            {
                ...
                businessInfo = new AcceptDocWebRef.BE01JBusinessInfoDTO();
                ...
                List<AcceptDocWebRef.BE01JCustomerInfoDTO> customers = new List<AcceptDocWebRef.BE01JCustomerInfoDTO>();

                foreach (XmlNode customerNode in customerInfoList)
                {
                    AcceptDocWebRef.BE01JCustomerInfoDTO customer = new AcceptDocWebRef.BE01JCustomerInfoDTO();
                    ...
                    List<AcceptDocWebRef.BE01JDocumentInfoDTO> documents = new List<AcceptDocWebRef.BE01JDocumentInfoDTO>();
                    ...
                    {
                        AcceptDocWebRef.BE01JDocumentInfoDTO document = new AcceptDocWebRef.BE01JDocumentInfoDTO();
                        ...
                        List<AcceptDocWebRef.BE01JImageInfoDTO> images = new List<AcceptDocWebRef.BE01JImageInfoDTO>();
                        ...
                        {
                            AcceptDocWebRef.BE01JImageInfoDTO image = new AcceptDocWebRef.BE01JImageInfoDTO();
                            ...
                            //image.imageSize = imageNode.SelectSingleNode("imageSize").InnerText.Trim();IsAccepted
                            image.imageAccepted = imageNode.SelectSingleNode("ImageAccepted").InnerText.Trim(); ;
                            ...
                            //List<AcceptDocWebRef.BE01JPersonIdentityInfoDTO> personsIdentities = new List<AcceptDocWebRef.BE01JPersonIdentityInfoDTO>();
                            ...
                            //{
                            //    AcceptDocWebRef.BE01JPersonIdentityInfoDTO personIdentity = new AcceptDocWebRef.BE01JPersonIdentityInfoDTO();
                            ...
                            //        AcceptDocWebRef.BE01JPersonInfoDTO person = new AcceptDocWebRef.BE01JPersonInfoDTO();
        ...
        protected bool GenerateXmlOutput(string filePath, AcceptDocWebRef.BE01JOutputDTO response, AcceptDocWebRef.BE01JBusinessInfoDTO businessInfo, AcceptDocWebRef.BE01JSystemInfoDTO systemInfo)
        {
            try
            {
                AcceptSendToCDB acceptSendToCDB = new AcceptSendToCDB();
                acceptSendToCDB.BE01JSystemInfoDTO = systemInfo;
                acceptSendToCDB.BE01JBusinessInfoDTO = businessInfo;
                acceptSendToCDB.BE01JOutputDTO = response;
                //sendToCDB.BE01JAuthenticationDTO = authentication;


                System.Xml.Serialization.XmlSerializer writer = new System.Xml.Serialization.XmlSerializer(typeof(AcceptSendToCDB));
                ...
                writer.Serialize(file, acceptSendToCDB);
        ...
        protected AcceptDocWebRef.BE01JDocumentInfoDTO[] GetDocumentInfo(DataTable docsTable, AcceptRequestorCustomer requestedCustomer, int docAppId, SendToCDBStageEnum stage, out int count)
        {
            //Get Doc info for a particular NRIC
            //Get document list for the customer
            List<AcceptDocWebRef.BE01JDocumentInfoDTO> documentList = new List<AcceptDocWebRef.BE01JDocumentInfoDTO>();
            count = 0;
                ...
                if (docsTable.Rows.Count > 0)
                {
                    ...
                    foreach (DataRow docRow in docsTable.Rows)
                    {
                        ...
                        if (docId.HasValue)
                        {
                            ...
                            {
                                AcceptDocWebRef.BE01JDocumentInfoDTO document;

                                DataRow row = dtDoc.Rows[0];
                                if (row != null)
                                {
                                    document = new AcceptDocWebRef.BE01JDocumentInfoDTO();
        ...
        private AcceptDocWebRef.BE01JImageInfoDTO[] GetImageInfo(DataTable dtDoc, AcceptRequestorCustomer requestedCustomer, int docAppId, SendToCDBStageEnum stage)
        {

            List<AcceptDocWebRef.BE01JImageInfoDTO> imageList = new List<AcceptDocWebRef.BE01JImageInfoDTO>();

            try
            {
                if (dtDoc.Rows.Count > 0)
                {
                    AcceptDocWebRef.BE01JImageInfoDTO image;
                    ...
                    foreach (DataRow row in dtDoc.Rows)
                    {
                        ...
                        if (row != null)
                        {
                            ...
                            image = new AcceptDocWebRef.BE01JImageInfoDTO();
                            ...
                            ////dwmsDocumentId
                            image.dwmsDocumentId = row["DocId"].ToString().Trim();
                            image.imageAccepted = String.IsNullOrEmpty(row["ImageAccepted"].ToString().Trim()) ? "U": row["ImageAccepted"].ToString();
        ...
        //private AcceptDocWebRef.BE01JPersonIdentityInfoDTO[] GetPersonIdentityInfo(int docId, string docType, AcceptRequestorCustomer requestedCustomer, int docAppId, SendToCDBStageEnum stage)
        //{
        //    try
        //    {
        ...
        //        List<AcceptDocWebRef.BE01JPersonIdentityInfoDTO> personIdentityList = new List<AcceptDocWebRef.BE01JPersonIdentityInfoDTO>();

        //        AcceptDocWebRef.BE01JPersonIdentityInfoDTO personIdentity1;
        //        AcceptDocWebRef.BE01JPersonIdentityInfoDTO personIdentity2;
        //        AcceptDocWebRef.BE01JPersonIdentityInfoDTO personIdentity3;
        //        AcceptDocWebRef.BE01JPersonIdentityInfoDTO personIdentity4;


        //        AppPersonalDb appPersonalDb = new AppPersonalDb();

        //        AcceptDocWebRef.BE01JPersonInfoDTO person;
        //        AcceptDocWebRef.BE01JPersonInfoDTO person2;
        ...
        //                    personIdentity1 = new AcceptDocWebRef.BE01JPersonIdentityInfoDTO();
        ...
        //                    personIdentity2 = new AcceptDocWebRef.BE01JPersonIdentityInfoDTO();
        ...
        //                    personIdentity3 = new AcceptDocWebRef.BE01JPersonIdentityInfoDTO();
        ...
        //                    personIdentity4 = new AcceptDocWebRef.BE01JPersonIdentityInfoDTO();
        ...
        //                    {
        //                        person = new AcceptDocWebRef.BE01JPersonInfoDTO();
        ...
        //                        personIdentity2 = new AcceptDocWebRef.BE01JPersonIdentityInfoDTO();// edited by calvin to take value when personidentity is empty
        ...
        //                        person2 = new AcceptDocWebRef.BE01JPersonInfoDTO();
